...
class Search():
    '''Байесовская игра по поиску пропавшего в море с 3 областями поиска.'''
    ...
    def draw_map(self, last_known):
        '''Отображаем карту, области поиска и последнее местонахождение моряка.'''
    ...
    def calculate_search_effectiveness(self):
        '''Устанавливаем десятичное значение поиска для каждой области'''
        self.sep1 = random.uniform(0.2, 0.9)
        self.sep2 = random.uniform(0.2, 0.9)
        self.sep3 = random.uniform(0.2, 0.9)

    def conduct_search(self, area_num, area_array, effectiveness_prob):
        '''Возвращаем результаты поиска и список координат'''
    ...
    def revise_target_probs(self):
        '''Обновляем вероятности целей в области поиска на основе эффективности поиска.'''
...
def main():
    ...
    while True:
        app.calculate_search_effectiveness()
